...
- Neural Network Libraries
    ...
    - [Elegy](https://poets-ai.github.io/elegy/) - Provides the Keras-like high-level API and functional PyTorch Lightning-like low-level API; supports Flax, Haiku, Optax, as well as TensorFlow Datasets and Pytorch DataLoaders; is 100% framework-agnostic on the low-level API. <img src="https://img.shields.io/github/stars/poets-ai/elegy?style=social" align="center">
